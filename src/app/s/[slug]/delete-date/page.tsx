...
import DeleteDatePageClient from "./page.client";
...
export async function generateMetadata({
  ...
  try {
    ...
    const title = `${storeName} — Delete your data`;
    const description = `Request deletion of personal data held by ${storeName}.`;
