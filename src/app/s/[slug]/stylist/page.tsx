...
import StylistPageClient from "./page.client";
...
export async function generateMetadata({
  ...
  try {
    ...
    const title = `${storeName} — Personal shopper`;
    const description = `AI personal shopper for ${storeName}. Describe the occasion and get a complete look you can try on and buy.`;
    ...
    return {
      metadataBase: new URL(baseUrl),
      title: `${slug} — Personal shopper`,
      description: "AI personal shopper.",
      alternates: { canonical: "./" },
