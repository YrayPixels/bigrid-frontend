...
function FaqPreview({
  ...
  return (
    <section className="px-6 py-12" style={{ backgroundColor: palette.surface }}>
      <h2 className="text-center text-2xl font-bold tracking-[-0.04em]" style={{ color: palette.primary }}>
      ...
      <div className="mx-auto mt-8 grid max-w-4xl gap-3 sm:grid-cols-2">
        {previewItems.map((item, index) => (
          ...
          >
            ...
            <p className="mt-3 leading-5" style={{ color: palette.muted }}>
              {item.answer}
            </p>
          </details>
        ))}
    ...
    <div style={{ backgroundColor: theme.palette.background, color: theme.palette.text }}>
      ...
      <section className="px-4 py-8 sm:px-6">
        <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          <ProductPack compact src={cosmeticsTemplateImages.cleanser} alt="Cosmetic cleanser products" />
          <div>
            <h2 className="text-5xl font-bold tracking-[-0.06em]" style={{ color: theme.palette.primary }}>
              Best Skin Cleanser
            </h2>
            <EditableText
              path="about.body"
            ...
            <div className="mt-8 grid max-w-xl grid-cols-3 gap-6">
              {[
                ...
                <div key={value}>
                  <div className="text-2xl font-black" style={{ color: theme.palette.primary }}>
                    {value}
                  </div>
      ...
      <section className="px-4 py-8 sm:px-6">
        <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-2">
          ...
          >
            <div>
              <h2 className="text-3xl font-bold tracking-[-0.05em]" style={{ color: theme.palette.primary }}>
                Our Best Serums
              </h2>
              <p className="mt-4 text-xs leading-6" style={{ color: theme.palette.muted }}>
            ...
            <ProductPack compact src={cosmeticsTemplateImages.serum} alt="Cosmetic serum products" />
          </div>
                ...
                {cosmeticsReasons.map(({ icon: Icon, title, body }) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-[11px] leading-4" style={{ color: theme.palette.muted }}>
                        {body}
                      </p>
                    </div>
                  </div>
      ...
      <FaqPreview items={storefront.pages?.faq?.items ?? []} palette={theme.palette} />
